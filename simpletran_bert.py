...
from transformers import glue_convert_examples_to_cnn_features as convert_examples_to_cnn_features
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    all_cnn_word_ids = torch.tensor(cnn_features['x'], dtype=torch.long)
...
def main():
    ...
    parser.add_argument('--word_emb_path', type=str, default='GoogleNews-vectors-negative300.bin', help='Path for word embeddings for TextCNN model')
